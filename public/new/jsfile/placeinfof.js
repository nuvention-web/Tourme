function placeinfof(tmpObject,tmpratinglist,resultprice,resultname,resultformattedphone,resultformattedaddress,resultrating,ratingcolor,tmpPhotoJason,PhotoURL,resultlat,resultlng,tmpmarker){

      if(tmpObject.categories == "Museum"){
          var tmpSP = MakeSinglePlace(resultname,resultformattedphone,resultformattedaddress,resultrating,ratingcolor,resultprice,tmpPhotoJason,PhotoURL,resultlat,resultlng,tmpmarker);
