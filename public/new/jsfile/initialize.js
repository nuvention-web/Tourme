// -----------------initizlice the map to location that user input-------------------//
  function initialize() {
...
// -----------------choose different categories-------------------//
        ...
        var categoriesID ;
          ...
          MuseumObject =  MakeCategoryObject("Museum",null,null,categoriesID);
          foursquare(categoriesID,MuseumObject);

          categoriesID = '4d4b7105d754a06374d81259';
          FoodObject =  MakeCategoryObject("Food",null,null,categoriesID);
          foursquare(categoriesID,FoodObject);

          categoriesID = '4bf58dd8d48988d1e5931735';
          MusicVenueObject =  MakeCategoryObject("MusicVenue",null,null,categoriesID);
          foursquare(categoriesID,MusicVenueObject);

          categoriesID = '4bf58dd8d48988d1f2931735';
          PArtObject =  MakeCategoryObject("PerformingArtVenue",null,null,categoriesID);
          foursquare(categoriesID,PArtObject);

          categoriesID = '4d4b7105d754a06376d81259';
          NSObject =  MakeCategoryObject("NightlifeSpot",null,null,categoriesID);
          foursquare(categoriesID,NSObject);

          categoriesID = '4d4b7105d754a06377d81259';
          ORObject =  MakeCategoryObject("OutDoorRecreation",null,null,categoriesID);
          foursquare(categoriesID,ORObject);

          categoriesID = '4bf58dd8d48988d103951735';    //only clothing
          SSObject =  MakeCategoryObject("ShopService",null,null,categoriesID);
          foursquare(categoriesID,SSObject);

          categoriesID = '4bf58dd8d48988d182941735';
          TPObject =  MakeCategoryObject("ThemePark",null,null,categoriesID);
          foursquare(categoriesID,TPObject);



// -----------------choose different categories and start fetch all data-------------------//
    ...
    function foursquare(categoriesID,tmpObject){
          ...
          $.ajax({
              ...
              var foursq ='https://api.foursquare.com/v2/venues/explore?ll='+ lat+','+lng +' &client_id='+clientid+'&client_secret='+clientsecret +' &v='+vdate+'&categoryId='+categoriesID + '&radius= 8000';
            ...
            success: function(json) {
              ...
              tmpratinglist = [ ];
                ...
                for (i = 0; i < 5; i++) {
                  ...
                  placeinfof(tmpObject,tmpratinglist,resultprice,resultname,resultformattedphone,resultformattedaddress,resultrating,ratingcolor,tmpPhotoJason,null,resultlat,resultlng,tmpmarker);
