  ...
  var categoriesID ;
    ...
    function foursquare(categoriesID,tmpObject){
          ...
          $.ajax({
              ...
              var foursq ='https://api.foursquare.com/v2/venues/explore?ll='+ NewhubLat+','+NewhubLng +' &client_id='+clientid+'&client_secret='+clientsecret +' &v='+vdate+'&categoryId='+categoriesID + '&radius= 3500';
              // + '&sortByDistance=1'
